    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="row">
                    <div className="col-md-4 col-12">
                        <label htmlFor="violencia_domestica" className={`${styles['text-cadastro']} form-label`}>Violência Doméstica</label>
                        <select
                            className="form-control"
                    ...
                    <div className="col-md-4 col-12">
                        <label htmlFor="discriminacao_rejeicao_familiar" className={`${styles['text-cadastro']} form-label`}>Descriminação ou Rejeição Familiar</label>
                        <select
                            className="form-control"
                    ...
                    <div className="col-md-4 col-12">
                        <label htmlFor="discriminacao_social_etnico_racial_sexual" className={`${styles['text-cadastro']} form-label`}>Descriminação Socail, Étnico, Racial ou Sexual</label>
                        <select
                            className="form-control"
                ...
                <div className="row">
                    <div className="col-md-6 col-12">
                        <label htmlFor="acesso_saude" className={`${styles['text-cadastro']} form-label`}>Acesso a Saúde</label>
                        <select
                            className="form-control"
                            name="acesso_saude"
                            id="acesso_saude"
                    ...
                    <div className="col-md-6 col-12">
                        <label htmlFor="acesso_esporte_cultura_lazer" className={`${styles['text-cadastro']} form-label`}>Acesso a Esporte, Cultura e Lazer</label>
                        <select
                            className="form-control"
