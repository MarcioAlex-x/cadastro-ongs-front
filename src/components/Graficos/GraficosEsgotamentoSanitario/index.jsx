...
export const GraficosEsgotamentoSanitario = ({ esgoto }) => {

    const data = [
        { name: 'Rede Pública', value: esgoto['Rede Pública'] },
        { name: 'Fossa', value: esgoto['Fossa'] },
        { name: 'Céu Aberto', value: esgoto['Céu Aberto'] },
        { name: 'Rio', value: esgoto['Rio'] },
    ]
