...
export const GraficosTipoConstrucao = ({ construcao }) => {

    const data = [
        { name: 'Alvenaria', value: construcao['Alvenaria'] },
        { name: 'Taipa', value: construcao['Taipa'] },
        { name: 'Materiais Recicláveis', value: construcao['Materiais Recicláveis']}
    ]
