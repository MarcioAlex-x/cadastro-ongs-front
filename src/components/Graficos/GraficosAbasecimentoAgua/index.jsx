...
export const GraficosAbastecimentoAgua = ({ agua }) => {

    const data = [
        { name: 'Rede Pública', value: agua['Rede Pública'] },
        { name: 'Poço', value: agua['Poço'] },
        { name: 'Ligação Clandestina', value: agua['Ligação Clandestina'] },
    ]
